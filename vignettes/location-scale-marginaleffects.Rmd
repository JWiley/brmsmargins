...
#> Intercept          -0.09      0.12    -0.34     0.15 1.00     4626     3436
#> sigma_Intercept     1.01      0.03     0.95     1.07 1.00     4920     2958
#> x                   1.62      0.45     0.76     2.51 1.00     4884     3160
#> grp                 1.03      0.34     0.35     1.69 1.00     3071     2884
#> sigma_x             0.85      0.09     0.67     1.02 1.00     4935     3218
#> sigma_grp           1.01      0.04     0.92     1.09 1.00     5093     3247
#> 
...
|-----:|-----:|----:|-----:|-----------:|----------:|----:|:------|:----|:---|:-----|
| 1.623| 1.625| 0.76| 2.509|          NA|         NA| 0.95|ETI    |NA   |NA  |AME x |
...
|     M|   Mdn|    LL|    UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label   |
|-----:|-----:|-----:|-----:|-----------:|----------:|----:|:------|:----|:---|:-------|
| 1.026| 1.028| 0.354| 1.687|          NA|         NA| 0.95|ETI    |NA   |NA  |AME grp |
...
|     M|   Mdn|    LL|    UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label |
|-----:|-----:|-----:|-----:|-----------:|----------:|----:|:------|:----|:---|:-----|
| 4.452| 4.438| 3.493| 5.467|          NA|         NA| 0.95|ETI    |NA   |NA  |AME x |
...
|     M|   Mdn|    LL|    UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label   |
|-----:|-----:|-----:|-----:|-----------:|----------:|----:|:------|:----|:---|:-------|
| 4.905| 4.898| 4.418| 5.424|          NA|         NA| 0.95|ETI    |NA   |NA  |AME grp |
...
ls.me <- brm(bf(
  ...
  chains = 4L, cores = 4L, backend = "cmdstanr")
#> Compiling Stan program...
#> 35 of 4000 (1.0%) transitions hit the maximum treedepth limit of 10 or 2^10-1 leapfrog steps.
...
#> sd(Intercept)                    1.18      0.09     1.02     1.36 1.02      184
#> sd(x)                            0.42      0.04     0.35     0.51 1.01      655
#> sd(sigma_Intercept)              1.26      0.10     1.09     1.47 1.02      305
#> sd(sigma_x)                      0.50      0.05     0.41     0.61 1.00     1152
#> cor(Intercept,x)                -0.39      0.12    -0.58    -0.13 1.00      581
#> cor(sigma_Intercept,sigma_x)    -0.36      0.11    -0.55    -0.13 1.00     1220
#>                              Tail_ESS
#> sd(Intercept)                     481
#> sd(x)                            1284
#> sd(sigma_Intercept)               785
#> sd(sigma_x)                      2251
#> cor(Intercept,x)                 1178
#> cor(sigma_Intercept,sigma_x)     2055
#> 
#> Population-Level Effects: 
#>                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> Intercept          -2.55      0.10    -2.77    -2.35 1.07       49      103
#> sigma_Intercept    -1.48      0.14    -1.78    -1.22 1.03      147      369
#> x                   0.94      0.05     0.83     1.05 1.00      705     1494
#> sigma_x             0.97      0.06     0.85     1.10 1.01     1028     1784
#> 
#> Draws were sampled using sample(hmc). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
...
|     M|   Mdn|    LL|    UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label |
|-----:|-----:|-----:|-----:|-----------:|----------:|----:|:------|:----|:---|:-----|
| 0.406| 0.405| 0.262| 0.558|          NA|         NA| 0.99|HDI    |NA   |NA  |AME x |
...
|     M|   Mdn|    LL|    UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label |
|-----:|-----:|-----:|-----:|-----------:|----------:|----:|:------|:----|:---|:-----|
| 0.795| 0.758| 0.358| 1.563|          NA|         NA| 0.99|HDI    |NA   |NA  |AME x |
...
|         M|       Mdn|        LL|        UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label |
|---------:|---------:|---------:|---------:|-----------:|----------:|----:|:------|:----|:---|:-----|
| 0.3763159| 0.3755472| 0.2480199| 0.5153142|          NA|         NA| 0.99|HDI    |NA   |NA  |AME x |
...
|         M|      Mdn|        LL|       UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label |
|---------:|--------:|---------:|--------:|-----------:|----------:|----:|:------|:----|:---|:-----|
| 0.7047945| 0.674385| 0.3157174| 1.363577|          NA|         NA| 0.99|HDI    |NA   |NA  |AME x |
