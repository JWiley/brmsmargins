...
#> sd(Intercept)        1.19      0.18     0.86     1.57 1.00      889     1096
#> sd(x)                0.53      0.25     0.06     1.03 1.01      389      799
#> cor(Intercept,x)    -0.19      0.39    -0.80     0.74 1.00     1142     1032
#> 
#> Regression Coefficients:
#>           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> Intercept    -2.49      0.19    -2.87    -2.15 1.00     1123     1540
#> x             0.96      0.17     0.63     1.31 1.00     1785     1306
#> 
...
|-----:|-----:|-----:|-----:|-----------:|----------:|----:|:------|:----|:---|:-----|
| 0.111| 0.111| 0.064| 0.162|          NA|         NA| 0.99|HDI    |NA   |NA  |AME x |
...
|-----:|-----:|-----:|-----:|-----------:|----------:|----:|:------|:----|:---|
| 0.119| 0.117| 0.074| 0.173|          NA|         NA| 0.99|HDI    |NA   |NA  |
| 0.229| 0.228| 0.166| 0.304|          NA|         NA| 0.99|HDI    |NA   |NA  |
...
|     M|  Mdn|    LL|    UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label |
|-----:|----:|-----:|-----:|-----------:|----------:|----:|:------|:----|:---|:-----|
| 0.111| 0.11| 0.064| 0.165|          NA|         NA| 0.99|HDI    |NA   |NA  |AME x |
...
|      M|   Mdn|       LL|      UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label |
|------:|-----:|--------:|-------:|-----------:|----------:|----:|:------|:----|:---|:-----|
| -0.599| 0.033| -165.279| 179.439|          NA|         NA| 0.99|HDI    |NA   |NA  |AME x |
...
|:--------|:----------------|:-------|:----------------|
|-2.018   |[-2.351, -1.646] |-2.021  |[-2.219, -1.833] |
|0.799    |[0.541, 1.074]   |0.802   |[0.561, 1.047]   |
...
#> ~ID (Number of levels: 100) 
#>                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> sd(Intercept)        1.19      0.15     0.92     1.51 1.00     1394     1980
#> sd(x)                0.39      0.19     0.04     0.75 1.00      426      784
#> cor(Intercept,x)    -0.07      0.39    -0.74     0.79 1.00     1347     1293
#> 
#> Regression Coefficients:
#>           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> Intercept    -2.48      0.18    -2.86    -2.15 1.00     1221     2069
#> x             0.97      0.15     0.69     1.28 1.00     2885     3135
#> 
#> Draws were sampled using sample(hmc). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
...
|     M|   Mdn|    LL|    UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label |
|-----:|-----:|-----:|-----:|-----------:|----------:|----:|:------|:----|:---|:-----|
| 0.332| 0.312| 0.137| 0.694|          NA|         NA| 0.99|HDI    |NA   |NA  |AME x |
...
|         M|       Mdn|        LL|        UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label |
|---------:|---------:|---------:|---------:|-----------:|----------:|----:|:------|:----|:---|:-----|
| 0.2934257| 0.2766797| 0.1317953| 0.5968962|          NA|         NA| 0.99|HDI    |NA   |NA  |AME x |
...
|MargCoef |MargCoefCI       |GLMCoef |GLMCI            |
|:--------|:----------------|:-------|:----------------|
|-1.782   |[-2.243, -1.257] |-1.858  |[-2.019, -1.705] |
|0.991    |[0.684, 1.271]   |0.983   |[0.802, 1.170]   |
...
#> ~ID (Number of levels: 100) 
#>                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> sd(Intercept)        1.19      0.17     0.90     1.57 1.00     1342     2468
#> sd(x)                0.52      0.21     0.07     0.91 1.00      415      539
#> cor(Intercept,x)    -0.30      0.33    -0.78     0.48 1.00     1810     1077
#> 
#> Regression Coefficients:
#>           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> Intercept    -2.50      0.19    -2.90    -2.15 1.00     1605     2152
#> x             1.01      0.17     0.68     1.37 1.00     2813     2758
#> 
#> Further Distributional Parameters:
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> shape  1552.78  38299.61     2.70   604.84 1.00     1691     1540
#> 
#> Draws were sampled using sample(hmc). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
...
|     M|  Mdn|    LL|    UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label |
|-----:|----:|-----:|-----:|-----------:|----------:|----:|:------|:----|:---|:-----|
| 0.295| 0.28| 0.114| 0.635|          NA|         NA| 0.99|HDI    |NA   |NA  |AME x |
...
|     M|   Mdn|  LL|    UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label |
|-----:|-----:|---:|-----:|-----------:|----------:|----:|:------|:----|:---|:-----|
| 0.256| 0.245| 0.1| 0.506|          NA|         NA| 0.99|HDI    |NA   |NA  |AME x |
...
|     M|   Mdn|    LL|    UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |
|-----:|-----:|-----:|-----:|-----------:|----------:|----:|:------|:----|:---|
| 0.122| 0.119| 0.058| 0.218|          NA|         NA| 0.99|HDI    |NA   |NA  |
| 0.232| 0.229| 0.124| 0.367|          NA|         NA| 0.99|HDI    |NA   |NA  |
...
|    M|   Mdn|    LL|    UL| PercentROPE| PercentMID|   CI|CIType |ROPE |MID |Label  |
|----:|-----:|-----:|-----:|-----------:|----------:|----:|:------|:----|:---|:------|
| 0.11| 0.108| 0.047| 0.188|          NA|         NA| 0.99|HDI    |NA   |NA  |AME xw |
...
|     M|    LL|    UL|   CI|CIType |
|-----:|-----:|-----:|----:|:------|
| 0.117| 0.051| 0.190| 0.95|HDI    |
| 0.144| 0.074| 0.221| 0.95|HDI    |
| 0.045| 0.017| 0.080| 0.95|HDI    |
| 0.265| 0.165| 0.368| 0.95|HDI    |
...
|      M|    Mdn|     LL|     UL| PercentROPE| PercentMID|   CI|CIType |ROPE          |MID                              |Label         |
|------:|------:|------:|------:|-----------:|----------:|----:|:------|:-------------|:--------------------------------|:-------------|
| -0.071| -0.068| -0.139| -0.012|       3.475|     73.375| 0.95|HDI    |[-0.02, 0.02] |[-Inf, -0.05] &#124; [0.05, Inf] |AME xw: Grp 0 |
|  0.122|  0.120|  0.038|  0.209|       0.825|     95.350| 0.95|HDI    |[-0.02, 0.02] |[-Inf, -0.05] &#124; [0.05, Inf] |AME xw: Grp 1 |
|  0.193|  0.190|  0.097|  0.298|       0.000|     99.950| 0.95|HDI    |[-0.02, 0.02] |[-Inf, -0.05] &#124; [0.05, Inf] |delta AME xw  |
